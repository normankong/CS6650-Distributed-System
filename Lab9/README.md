...
|#| Lab 7 | Lab8|
|-|------|---|
|Message Channel| Send to Single Queue | Send to Exchange with fanout mode in order to send multiple consumer |
|Connection Pool |Apache JDBC |  Hikari JDBC Connection Pool|
|Rabbit MQ EC2 Type|t2.micro |  t2.large |
